            ...
            <table class="table table-striped table-hover text-center">
                <tbody>
                    <?php
                        ...
                        //...
                        //On prépare la requête (qui a été testée au préalable)
                        $requete1="SELECT * FROM t_profil_pfl ORDER BY pfl_date ASC;";
                        //On exécute la requête et on teste sa bonne exécution
                        ...
                        {
                        //On récupère le nombre de lignes du résultat
                        echo "<br />";
                        ...
                        echo "<br />";
                        //On utilise une fonction de type fetch pour récupérer les
                        //éléments contenus dans le résultat
