            ...
            ?>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="inscription/inscription.php">s'inscrire</a></li>
                        <li class="nav-item"><a class="nav-link" href="session/session.php">Se connecter</a></li>
